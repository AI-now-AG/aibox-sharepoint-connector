...
<div class="w-full shadow-md border border-gray-200 rounded bg-base-100">
  ...
  >
    ...
    <button
      class="btn btn-square text-red-800 fill-current bg-base-content grid justify-items" type="submit">
      <svg class="stroke-neutral-content stroke-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
