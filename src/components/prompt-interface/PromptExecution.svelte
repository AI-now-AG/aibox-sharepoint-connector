...
<div class="grid grid-cols-1 grid-rows-[1fr_min-content] h-full">
  <div class="flex flex-col space-y-6">
    ...
    {#if [PromptModel.OpenAIWithTools, PromptModel.OpenAIWithImageTools, PromptModel.Claude, PromptModel.Perplexity, PromptModel.OpenAIGpt5, PromptModel.OpenAIGpt5WithTools, PromptModel.OpenAIGpt5WithImageTools, PromptModel.Gemini, PromptModel.Default].includes(currentPrompt?.model) || (isGpt5Default() && !currentPrompt?.model)}
      <StreamingChatWidget
