...
const en = {
  ...
  "tenant.update-successful": "Update tenant successful",
};
...
const de = {
  ...
  "tenant.update-successful": "Mieter erfolgreich aktualisiert",
};
