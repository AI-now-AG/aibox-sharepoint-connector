/**
 * Auto-generated trigger file for "aibox SharePoint Connector" API.
 * Generated at: 2026-03-10T09:25:58.059Z
 * Mass generator version: 1.0.3
 *
 * : aibox-sharepoint-connector
 * Copyright © 2023,  AG
 *
...
async function processTrigger(msg, cfg, snapshot, incomingMessageHeaders, tokenData) {
  ...
  try {
    ...
    let securities = {};
  securities["ConnectorApiKey"] = cfg["key"];
    ...
    const paginationConfig = {"pageTokenOption":{},"pageSizeOption":{},"strategy":{"type":"no_pagination","pageSize":50,"tokenIn":"body"}};
